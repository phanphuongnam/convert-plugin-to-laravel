<?php
//  require "C:/Users/NETBASE/Desktop/Laravel/Aimeos/nbdesignonline/index.php";
$url = base_path();
// dd(storage_path());

// require $url . "/nbdesignonline/function-define-wordpress/plugin.php";
// require $url . "nbdesignonline/nbdesigner.php";
require $url . "/nbdesignonline/function-define-wordpress/functions.php";
echo "<pre>";
							...
							<div class="addbasket">
								<div class="input-group">
									...
									<button class="btn btn-primary btn-lg" type="submit" value="" <?= !$this->detailProductItem->isAvailable() ? 'disabled' : '' ?> >
										<?= $enc->html( $this->translate( 'client', 'Add to cart test' ), $enc::TRUST );?> 
